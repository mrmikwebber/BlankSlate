...
export default function AllAccountsTile() {
  ...
  return (
    <div className="bg-slate-50 rounded-2xl border shadow p-6 space-y-4 w-full">
      ...
      {accounts.length === 0 ? (
        <div className="text-center text-slate-600 py-6">
          ...
          <button
            onClick={() => setShowModal(true)}
            className="bg-ledger-600 hover:bg-ledger-500 text-white px-4 py-2 rounded-md transition"
          >
            Add Account
          </button>
        </div>
