      ...
      <DialogContent className={cn(dialogSheetOnMobile, "sm:max-w-md")}>
        <DialogHeader>
          ...
          <DialogDescription className="dark:text-slate-400">
            Manually enter your account details.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className={`rounded-lg border px-3 py-2 text-sm font-medium transition-colors ${
                    subtype === s.value
                      ...
                      : "border-slate-200 bg-slate-50 text-slate-600 hover:border-slate-300 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-slate-600"
                  }`}
                >
                  {s.label}
                </button>
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <Button type="submit" className="bg-ledger-600 hover:bg-ledger-700">
              Add Account
            </Button>
          </div>
        </form>
